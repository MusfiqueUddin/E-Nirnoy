...
public class CitycorElectionController {
        @FXML
        ...
        @FXML
        private VBox candidateListContainer;
        ...
        public void initialize() {
            ...
            mayorToggleButton.setOnAction(event -> showCandidates("mayor"));
            councilorToggleButton.setOnAction(event -> showCandidates("councilor"));
            womanCouncilorToggleButton.setOnAction(event -> showCandidates("womanCouncilor"));
        }
        ...
        private void showCandidates(String position) {
            // Clear the ListView
